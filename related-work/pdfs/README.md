...
- HTML snapshots (product docs, Faiss wiki) are saved as `.pdf` for reference only — not academic PDFs.
...
| HTML snapshot | Pinecone, Weaviate, Qdrant, OpenSearch, Faiss wiki | Not paper PDFs |
